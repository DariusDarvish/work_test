...
@Component({
  selector: 'app-product-preformance',
  templateUrl: './product-preformance.component.html',
  styleUrls: ['./product-preformance.component.scss']
})
export class ProductPreformanceComponent implements OnInit {
  Title = 'Product Preformance';
  columnDefs = [
  ...
  ngOnInit() {
    this.titleService.setTitle("Product preformance");
    this.data.currentTitle.subscribe(Title => this.Title = Title)
    this.data.changeTitle('Product performance Report')
