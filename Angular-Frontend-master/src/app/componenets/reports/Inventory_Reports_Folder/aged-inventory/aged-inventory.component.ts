...
@Component({
  selector: 'app-aged-inventory',
  templateUrl: './aged-inventory.component.html',
  styleUrls: ['./aged-inventory.component.scss']
})
export class AgedInventoryComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle("Aged inventory");
    this.data.currentTitle.subscribe(Title => this.Title = Title)
    this.data.changeTitle('Aged Inventory')
