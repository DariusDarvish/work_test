...
@Component({
  selector: 'app-inventory-costing',
  templateUrl: './inventory-costing.component.html',
  styleUrls: ['./inventory-costing.component.scss']
})
export class InventoryCostingComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle("Inventory cost");
    this.data.currentTitle.subscribe(Title => this.Title = Title)
    this.data.changeTitle('Inventory costing')
