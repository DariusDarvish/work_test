...
@Component({
  selector: 'app-seasonal-forcast',
  templateUrl: './seasonal-forcast.component.html',
  styleUrls: ['./seasonal-forcast.component.scss']
})
export class SeasonalForcastComponent implements OnInit {
  Title = 'Seasonal Forcast';
  columnDefs = [
  ...
  ngOnInit() {
    ...
    this.data.changeTitle('Seasonal forcast')
  ...
  onGridReady(params) {
    this.titleService.setTitle("Seasonal forcast");
    //this.rowData = this.http.get('/api/reports/all_listing');
