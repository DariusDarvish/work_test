...
@Component({
  selector: 'app-standard-forcast',
  templateUrl: './standard-forcast.component.html',
  styleUrls: ['./standard-forcast.component.scss']
})
export class StandardForcastComponent implements OnInit {
  Title = 'Standard Forcast';
  ...
  ngOnInit() {
    this.titleService.setTitle("Standard forcast");
    this.data.currentTitle.subscribe(Title => this.Title = Title)
    this.data.changeTitle('Standard Forcast')
